...
![DockerHub Repository](screenshots/docker_repo.png)
...
![ArgoCD Application Status](screenshots/argo_cd.png)
...
![kubectl Verification](screenshots/kub_ctl_cmd.png)
...
![Live Application](screenshots/project_deploymentdeployment_.png)
...
![Grafana Dashboard](screenshots/grafana_dashboard_.png)

## Challenges & Fixes
*(Edit this section to reflect what actually happened — keep only what's true, delete the rest)*
